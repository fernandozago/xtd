...
TEST_CASE_METHOD(BoundedChannel, "Semantics - copy, move, emplace")
{
...
TEST_CASE_METHOD(UnboundedChannel, "Semantics - copy, move, emplace")
{
    struct ChannelSemanticsProbe
    {
        std::shared_ptr<int> payload;
...
TEST_CASE_METHOD(BoundedChannel, "try_push returns false when full and does not block")
{
...
TEST_CASE_METHOD(BoundedChannel, "try_push returns false after completion")
{
...
TEST_CASE_METHOD(BoundedChannel, "try_emplace returns false when full and does not block")
{
    xtd::channel<int> channel(1);
    xtd::channel_writer<int>& writer = channel.writer();
...
TEST_CASE_METHOD(BoundedChannel, "try_emplace returns false after completion")
{
    xtd::channel<int> channel(2);
    xtd::channel_writer<int>& writer = channel.writer();
...
TEST_CASE_METHOD(UnboundedChannel, "try_emplace succeeds before completion and fails after")
{
...
TEST_CASE_METHOD(UnboundedChannel, "try_push succeeds before completion and fails after")
{
    xtd::channel<int> channel;
    xtd::channel_writer<int>& writer = channel.writer();
    xtd::channel_reader<int>& reader = channel.reader();
...
TEST_CASE_METHOD(BoundedChannel, "reader get_size reflects enqueue and dequeue")
{
...
TEST_CASE_METHOD(UnboundedChannel, "reader get_size reflects enqueue and dequeue")
{
    xtd::channel<int> channel;
    xtd::channel_writer<int>& writer = channel.writer();
    xtd::channel_reader<int>& reader = channel.reader();
...
TEST_CASE_METHOD(BoundedChannel, "push blocks when full and resumes after read")
{
    xtd::channel<int> channel(1);
...
TEST_CASE_METHOD(BoundedChannel, "blocked push returns false when channel is completed")
{
    xtd::channel<int> channel(1);
    xtd::channel_writer<int>& writer = channel.writer();
...
TEST_CASE_METHOD(BoundedChannel, "read blocks while empty and unblocks on complete")
{
    xtd::channel<int> channel(2);
    auto& writer = channel.writer();
    auto& reader = channel.reader();
...
TEST_CASE_METHOD(UnboundedChannel, "read blocks while empty and unblocks on complete")
{
    xtd::channel<int> channel;
    auto& writer = channel.writer();
    auto& reader = channel.reader();
...
TEST_CASE_METHOD(UnboundedChannel, "read blocks while empty and unblocks on pushed value")
{
    xtd::channel<int> channel;
    auto& writer = channel.writer();
    auto& reader = channel.reader();
...
TEST_CASE_METHOD(UnboundedChannel, "read returns nullopt after completion when empty")
{
    xtd::channel<int> channel;
    xtd::channel_writer<int>& writer = channel.writer();
    xtd::channel_reader<int>& reader = channel.reader();
...
TEST_CASE_METHOD(UnboundedChannel, "channel_reader - test stop token when block reading")
{
    xtd::channel<int> channel;
    xtd::channel_reader<int>& reader = channel.reader();
...
TEST_CASE_METHOD(UnboundedChannel, "channel_writer - test stop token when block writing")
{
    xtd::channel<int> channel;
    xtd::channel_writer<int>& writer = channel.writer();
...
TEST_CASE_METHOD(BoundedChannel, "blocked push is canceled by stop token")
{
    xtd::channel<int> channel(1);
    auto& writer = channel.writer();
    auto& reader = channel.reader();
...
TEST_CASE_METHOD(BoundedChannel, "blocked read is canceled by stop token")
{
    xtd::channel<int> channel;
    auto& reader = channel.reader();
...
TEST_CASE_METHOD(BoundedChannel, "supports ring-buffer wrap-around correctly")
{
    xtd::channel<int> channel(3);
    xtd::channel_writer<int>& writer = channel.writer();
    xtd::channel_reader<int>& reader = channel.reader();
...
TEST_CASE_METHOD(BoundedChannel, "emplace constructs the value in place")
{
    struct probe
    {
...
TEST_CASE_METHOD(BoundedChannel, "lvalue push blocks when full and resumes after read")
{
    xtd::channel<int> channel(1);
    auto& writer = channel.writer();
    auto& reader = channel.reader();
...
TEST_CASE_METHOD(BoundedChannel, "emplace waits for capacity before constructing")
{
...
TEST_CASE_METHOD(BoundedChannel, "Channel read of move-only value blocks and resumes after emplace")
{
    std::atomic<int> constructions = 0;
...
TEST_CASE_METHOD(BoundedChannel, "completion wakes all blocked readers")
{
    xtd::channel<int> channel;
    auto& writer = channel.writer();
    auto& reader = channel.reader();
...
TEST_CASE_METHOD(BoundedChannel, "completion wakes all blocked writers")
{
    xtd::channel<int> channel(1);
    auto& writer = channel.writer();
    auto& reader = channel.reader();
